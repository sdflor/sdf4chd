...
if __name__ == '__main__':
    ...
    tester = NDFTester(device, cell_grid_size=args.grid_size, out_dim=cfg['net']['out_dim'])
    ...
    MODE = ['test']
    cfg['data']['test_output_dir'] = os.path.join(cfg['data']['output_dir'], MODE[0]+ '_lat{}_opt_{}'.format(cfg['net']['test_l_dim'], args.epoch))
